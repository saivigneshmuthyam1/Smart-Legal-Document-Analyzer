      ...
      <div className="flex-1 pt-14 flex items-stretch">
        ...
        <aside className="w-64 bg-white border-r border-border fixed left-0 top-14 bottom-0 flex flex-col justify-between z-30">
            ...
            {isDocActiveView ? (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h4 className="font-semibold text-[14px] mt-1 text-primary">Juris Precision</h4>
                  <p className="text-[11px] text-text-secondary">Corporate Legal Space</p>
                </div>
          ...
          <div className="p-4 border-t border-border bg-primary-50 space-y-3">
            ...
            <hr className="border-border" />
            <Link to="/login" className="flex items-center gap-2.5 text-[13px] text-risk-red hover:text-risk-red font-medium transition-colors">
